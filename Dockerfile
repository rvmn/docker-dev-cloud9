...
# Install base
RUN apt-get update
RUN apt-get install -y software-properties-common htop build-essential g++ curl libssl-dev apache2-utils git libxml2-dev sshfs wget nano ruby ruby-dev ruby-bundler
